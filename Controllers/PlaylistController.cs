...
namespace Eargasm.Controllers
{
    ...
    public class PlaylistController : Controller
    {
        ...
        public PlaylistController(EargasmContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Url,Created")] Playlist playlist)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Url,Created")] Playlist playlist)
        {
            if (id != playlist.Id)
            {
                return NotFound();
